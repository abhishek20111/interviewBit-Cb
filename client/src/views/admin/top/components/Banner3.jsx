...
const Banner3 = () => {
    ...
    useEffect(() => {
        if (allProducts.length > 0) {
            const sortedByRating = [...allProducts].sort((a, b) => a.piecesRemaining - b.piecesRemaining);
        ...
        <div key={product.id} className="flex w-full items-center justify-between rounded-2xl bg-white p-3 shadow-3xl shadow-shadow-500 dark:!bg-navy-700 dark:shadow-none">
            <div className="flex items-center">
                ...
                <div className="ml-4">
                    ...
                    Remaining Pieces: {product.piecesRemaining.toFixed(1)}
                    </p>
                </div>
            </div>
    ...
    return (
        <Card extra="w-full p-4 h-full m-4">
            <div className="mb-8 w-full">
                <h4 className="text-xl font-bold text-navy-700 dark:text-white">Top 5 Products Based on Remaining Pieces Of The Product</h4>
                <p className="mt-2 text-base text-gray-600">Discover the top 5 products based on remaining pieces of the product.</p>
            </div>
